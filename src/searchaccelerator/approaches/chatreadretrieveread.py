...
class ChatReadRetrieveReadApproach(Approach):
    ...
    with open(os.path.join(os.path.dirname(__file__), "..\config\prompts\\readretriveconfig.json"), "r") as f:
        chatreadretrieveconfig = json.load(f)
    system_message_chat_conversation = chatreadretrieveconfig["chat_template"]["main_content"]
    follow_up_questions_prompt_content = chatreadretrieveconfig['chat_template']['follow_up_questions_prompt']

    query_prompt_template = chatreadretrieveconfig["chat_template"]["conversation_history"]
    query_prompt_few_shots = chatreadretrieveconfig["chat_template"]["conversation"]
