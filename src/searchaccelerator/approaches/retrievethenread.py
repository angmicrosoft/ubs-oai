...
class RetrieveThenReadApproach(Approach):
    ...
    with open(os.path.join(os.path.dirname(__file__), "..\config\prompts\\readretriveconfig.json"), "r") as f:
        readRetriveConfig = json.load(f)

    system_chat_template = readRetriveConfig['chat_template']['system_message']

    # shots/sample conversation
    question = readRetriveConfig['chat_template']['question']
    answer = readRetriveConfig['chat_template']['answer']
